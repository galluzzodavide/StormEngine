...
anno = '2024' # Usiamo un anno completo e concluso
        ...
        with zipfile.ZipFile(zip_path, 'r') as zip_ref:
            for info in zip_ref.infolist():
                if info.filename.endswith('.nc'):
                    ...
                    # Su Windows os.rename fallisce se il file di destinazione esiste già.
                    # Lo rimuoviamo prima, per permettere la sovrascrittura come su Linux/Mac.
